...
@LocalDeploy({
        "org.nuxeo.ecm.core.event.kafka.test:test-async-core-listeners.xml",
        "org.nuxeo.ecm.core.event.kafka.test:test-kafka-service-contrib.xml"
})
public class TestCoreEventsWithKafka {
    ...
    public void testCoreEventsMarshalling() throws Exception {
        ...
        // check that event context properties are correctly marshaled !
